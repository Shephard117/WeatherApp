...
extension DescriptionController {
    ...
    func setUI(){
        ...
        NSLayoutConstraint.activate([
            ...
            cityLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 150)
        ])
        
        view.addSubview(weatherImage)
        NSLayoutConstraint.activate([
            weatherImage.topAnchor.constraint(equalTo: cityLabel.bottomAnchor, constant: 20),
            weatherImage.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 200),
        ...
        NSLayoutConstraint.activate([
            ...
            tempLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 200),
        ...
        NSLayoutConstraint.activate([
            windLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 100),
        ...
        NSLayoutConstraint.activate([
            ...
            pressureLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 100)
        ])
        
        view.addSubview(feelsLike)
        NSLayoutConstraint.activate([
            feelsLike.topAnchor.constraint(equalTo: pressureLabel.bottomAnchor, constant: 10),
            feelsLike.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 100)
        ])
...
extension DescriptionController: WeatherControllerDelegate {
    ...
    func updateWeather(with weather: WeatherModel) {
        DispatchQueue.main.async {
            ...
            self.pressureLabel.text = "Атмосферное давление: \(weather.pressure)"
            self.feelsLike.text = "Ощущается как: \(weather.feelsLike)"
            self.windLabel.text = "Скорость ветра: \(weather.windSpeed)"
